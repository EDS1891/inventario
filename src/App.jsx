...
const CARGOS_REG = ['Administración Palacio','Atención al Socio','Coordinación','Director Técnico','Ayudante Técnico','Videoanalista','Preparador Físico','Entrenador de Arqueros','Doctor/a','Kinesiólogo/a','Utilero']
const CARGOS_SIN_SECTOR = ['Administración Palacio','Atención al Socio']
